...
[GitHub](https://github.com/Ivey-Business-School/xtools/issues).
...
<https://Ivey-Business-School.github.io/xtoosd/> which contains the
following vignettes:

-   [Getting
    Started](https://Ivey-Business-School.github.io/tools/articles/getting-started.html)
...
Future iterations may expand to include more functions that interact
with X.
...
Conduct](https://github.com/Ivey-Business-School.github.io/xtools/blob/master/.github/CODE_OF_CONDUCT.md).
